...
#SBATCH --job-name=getMenEmb_all_taxonomy

#SBATCH --output=logs/get_mention_embeddings/out_get_taxonomy_mention_embeddings.txt
#SBATCH --error=logs/get_mention_embeddings/err_get_taxonomy_mention_embeddings.txt
